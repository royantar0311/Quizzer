...
const StartQuiz: FC = () => {
	...
	const [data, _, errors, setErrors, handleChange] = useForm(
		initialState,
		true,
		validate
	);
	const quiz: QuizType[] = useSelector(
			...
			<div className={classes.left}>
				<Paper elevation={0} className={classes.leftPaper}>
					...
					<Typography variant="h5">
						<span style={{ color: '#666666' }}>{quiz[0].description}</span>
					</Typography>
					<br />
					<br />
					<Typography variant="subtitle2">
						<span style={{ color: '#858585' }}>
							Instructions: {quiz[0].instructions}
						</span>
					</Typography>
				</Paper>
			</div>
