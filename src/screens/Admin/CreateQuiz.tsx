...
const CreateQuiz: FC = () => {
    ...
    const [modalInputState, setModalInputState] = useState<Question>(intialModalInputState);
    ...
    const changeModalState = (status: boolean, mode: string, question?: Question) => {
        setModalOpen({
            status,
            mode
        });
    ...
    const handleModalSubmit = () => {
        if (isModalOpen.mode === 'create') {
            ...
            setRecords([modalInputState, ...records.filter((question) => question.id !== modalInputState.id)]);
        }
    ...
    return (
        <>
            <Paper elevation={0} className={classes.paperStyle}>
                    ...
                    <Grid item>
                        <ChipInput
                            ...
                            onDelete={(chip, index) => {
                                ...
                                setRecords([...records.filter(record => record.category !== chip)]);
                            }}
                        />
                    </Grid>
                ...
                <button className="aq__button" onClick={() => changeModalState(true, 'create')}>Add Question</button>
                    ...
                    <div style={modalStyle} className={classes.paper}>
                        ...
                        <form className="app__form">
                            <Controls.Input
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => setModalInputState({ ...modalInputState, questionText: e.target.value })}
                            /> <br />
                            <Controls.Input
                                type="text"
                                label="Options"
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => setModalInputState({ ...modalInputState, options: e.target.value })}
                            /> <br />
                            <Controls.Input
                                type="text"
                                label="Emotions"
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => setModalInputState({ ...modalInputState, emotions: e.target.value })}
                            /> <br />
                            <Controls.Input
                                type="text"
                                label="Weights"
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => setModalInputState({ ...modalInputState, weights: e.target.value })}
                            /> <br />
                            <Controls.Input
                                type="text"
                                label="Category"
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => setModalInputState({ ...modalInputState, category: e.target.value })}
                            /> <br />
                            <Controls.Input
                                type="text"
                                label="Image Link"
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => setModalInputState({ ...modalInputState, imageLink: e.target.value })}
                            /> <br />
                            <button className="modal__button" onClick={handleModalSubmit}>{isModalOpen.mode === 'create' ? 'Add' : 'Edit'} this Question to the Quiz</button>
                        </form>
                    </div>
                </Modal>
                            ...
                            records.map((question) =>
                                <TableRow key={question.id}>
                                    ...
                                    <TableCell>
                                        {
                                            <div>
                                                <ActionButton onClick={() => changeModalState(true, 'edit', question)}>
                                                    <EditIcon />
                                                </ActionButton>
                                                <ActionButton onClick={() => setRecords([...records.filter(record => record.id !== question.id)])}>
                                                    <CancelIcon />
                                                </ActionButton>
                                            </div>
                                        }
                ...
                <TblPagination />
                <button className="aq__button">Create Quiz</button>
            </Paper>
        </>
    )
}
